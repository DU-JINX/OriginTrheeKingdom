...
public class UIPanel : UIRect
{
	...
	/// <summary>
	/// By default, non-clipped panels use the GetComponent<Camera>()'s bounds, and the panel's position has no effect.
	...
	/// <summary>
	/// Whether the GetComponent<Camera>() is used to draw UI geometry.
	/// </summary>
	...
	protected override void OnInit ()
	{
		...
		// Apparently having a GetComponent<Rigidbody>() helps
