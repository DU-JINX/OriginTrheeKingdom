...
public class UITooltip : MonoBehaviour
{
	...
	protected virtual void SetText (string tooltipText)
	{
		if (text != null && !string.IsNullOrEmpty(tooltipText))
		{
			...
			// Orthographic GetComponent<Camera>() positioning is trivial
			...
			if (uiCamera != null)
			{
				...
				// Calculate the ratio of the GetComponent<Camera>()'s target orthographic size to current screen size
			...
			else
			{
				...
				// Simple calculation that assumes that the GetComponent<Camera>() is of fixed size
