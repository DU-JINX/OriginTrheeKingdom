...
public class UIAnchor : MonoBehaviour
{
	...
	/// <summary>
	/// Object used to determine the container's bounds. Overwrites the GetComponent<Camera>()-based anchoring if the value was specified.
	/// </summary>
	...
	/// <summary>
	/// Automatically find the GetComponent<Camera>() responsible for drawing the widgets under this object.
	/// </summary>
