...
/// <summary>
/// Very simple sprite GetComponent<Animation>(). Attach to a sprite and specify a common prefix such as "idle" and it will cycle through them.
/// </summary>
...
public class UISpriteAnimation : MonoBehaviour
{
	...
	/// <summary>
	/// Number of frames in the GetComponent<Animation>().
	/// </summary>
	...
	/// <summary>
	/// Set the GetComponent<Animation>() to be looping or not
	/// </summary>

	public bool loop { get { return mLoop; } set { mLoop = value; } }

	/// <summary>
	/// Returns is the GetComponent<Animation>() is still playing or not
	/// </summary>
	...
	/// <summary>
	/// Advance the sprite GetComponent<Animation>() process.
	/// </summary>
	...
	/// <summary>
	/// Reset the GetComponent<Animation>() to frame 0 and activate it.
	/// </summary>
