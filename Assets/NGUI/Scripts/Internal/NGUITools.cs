...
static public class NGUITools
{
	...
	/// <summary>
	/// Play the specified GetComponent<AudioSource>() clip.
	/// </summary>

	static public AudioSource PlaySound (AudioClip clip) { return PlaySound(clip, 1f, 1f); }

	/// <summary>
	/// Play the specified GetComponent<AudioSource>() clip with the specified volume.
	/// </summary>

	static public AudioSource PlaySound (AudioClip clip, float volume) { return PlaySound(clip, volume, 1f); }

	/// <summary>
	/// Play the specified GetComponent<AudioSource>() clip with the specified volume and pitch.
	/// </summary>
	...
	/// <summary>
	/// Find the GetComponent<Camera>() responsible for drawing the objects on the specified layer.
	/// </summary>
	...
	/// <summary>
	/// Add a GetComponent<Collider>() to the game object containing one or more widgets.
	/// </summary>
	...
	/// <summary>
	/// Adjust the widget's GetComponent<Collider>() based on the depth of the widgets, as well as the widget's dimensions.
	/// </summary>
	...
	static public UIPanel CreateUI (Transform trans, bool advanced3D, int layer)
	{
		...
		if (panel == null)
		{
			...
			for (int i = 0; i < cameras.Length; ++i)
			{
				...
				// Make sure this GetComponent<Camera>() can't see the UI
				c.cullingMask = (c.cullingMask & (~mask));
			}

			// Create a GetComponent<Camera>() that will draw the UI
			...
			// Make sure there is an GetComponent<AudioSource>() listener present
	...
	/// <summary>
	/// Get sides relative to the specified GetComponent<Camera>(). The order is left, top, right, bottom.
	/// </summary>
	...
	/// <summary>
	/// Get the GetComponent<Camera>()'s world-space corners. The order is bottom-left, top-left, top-right, bottom-right.
	/// </summary>
