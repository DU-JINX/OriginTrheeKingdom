...
public abstract class UIRect : MonoBehaviour
{
	...
	/// <summary>
	/// Helper function -- attempt to find the GetComponent<Camera>() responsible for the specified anchor.
	/// </summary>

	void FindCameraFor (AnchorPoint ap)
	{
		// If we don't have a target or have a rectangle to work with, GetComponent<Camera>() isn't needed
		...
		{
			// Find the GetComponent<Camera>() responsible for the target object
