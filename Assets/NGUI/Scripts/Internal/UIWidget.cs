...
public class UIWidget : UIRect
{
	...
	/// <summary>
	/// If set to 'true', the box GetComponent<Collider>()'s dimensions will be adjusted to always match the widget whenever it resizes.
	/// </summary>
	...
	/// <summary>
	/// Convenience function that returns 'true' if the widget has a box GetComponent<Collider>().
	/// </summary>
	...
	/// <summary>
	/// Adjust the widget's GetComponent<Collider>() size to match the widget's dimensions.
	/// </summary>
