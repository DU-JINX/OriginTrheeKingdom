...
/// <summary>
/// Works together with UIDragCamera script, allowing you to drag a secondary GetComponent<Camera>() while keeping it constrained to a certain area.
/// </summary>
...
public class UIDraggableCamera : MonoBehaviour
{
	...
	/// <summary>
	/// Constrain the current GetComponent<Camera>()'s position to be within the viewable area's bounds.
	/// </summary>
