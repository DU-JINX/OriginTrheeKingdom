...
/// <summary>
/// Play the specified GetComponent<Animation>() on click.
/// </summary>
...
{
	/// <summary>
	/// Target GetComponent<Animation>() to activate.
	/// </summary>

	public Animation target;

	/// <summary>
	/// Optional clip name, if the GetComponent<Animation>() has more than one clip.
	/// </summary>

	public string clipName;

	/// <summary>
	/// Which event will trigger the GetComponent<Animation>().
	/// </summary>
	...
	/// <summary>
	/// Whether the GetComponent<Animation>()'s position will be reset on play or will continue from where it left off.
	/// </summary>

	public bool resetOnPlay = false;

	/// <summary>
	/// Whether the selected object (this button) will be cleared when the GetComponent<Animation>() gets activated.
	/// </summary>
	...
	/// <summary>
	/// What to do with the target when the GetComponent<Animation>() finishes.
	/// </summary>
	...
	/// <summary>
	/// Start playing the GetComponent<Animation>().
	/// </summary>
